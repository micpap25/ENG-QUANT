...
from ipm._inexact_infeasible_IPM import inexact_infeasible_IPM
	...
	def solve(self):
		...
		if "IR-" in self.Params.Method:
			...
			if "II-QIPM" in self.Params.Method:
				...
				print("  1- \"IR-II-QIPM\": Iterative Refinement Inexact Infeasible Quantum Interior-Point method")
				print("  2- \"IR-II-IPM\": Iterative Refinement Inexact Infeasible Interior-Point method")
				print("  3- \"IR-IF-QIPM\": Iterative Refinement Inexact Feasible Quantum Interior-Point method")
				print("  4- \"IR-IF-IPM\": Iterative Refinement Inexact Feasible Interior-Point method")
				sys.exit("Please select the method correctly!")

		
		elif self.Params.Method == "II-IPM":
			self.Params.Is_Quantum 		= False
